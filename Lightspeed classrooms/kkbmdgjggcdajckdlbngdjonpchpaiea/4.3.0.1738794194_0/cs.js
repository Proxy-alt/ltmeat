    ...
    1: [function(e, t, n) {
        ...
        var c, r, i = {
            ...
            Object.assign(t.style, {
                ...
                textAlign: "center",
                background: "linear-gradient(to bottom, #ebebeb, #dddddd)",
            ...
            Object.assign(n.style, {
                alignItems: "center",
                backgroundImage: "linear-gradient(-180deg, ".concat(i[e.type][1], " 0%, ").concat(i[e.type][0], " 100%)"),
                borderRadius: "64px",
                boxShadow: "0 15px 30px 0 rgba(0, 0, 0, 0.10)",
            ...
            p.setAttribute("height", "48"),
            p.setAttribute("xmlns", "http://www.w3.org/2000/svg"),
            p.style.position = "relative",
            p.style.left = "4px";
            var u = document.createElementNS("http://www.w3.org/2000/svg", "path");
            if (u.setAttribute("d", a[e.type]),
            u.setAttribute("fill", i[e.type][0]),
            "pass" === e.type && u.setAttribute("transform", "scale(0.1)"),
            o.innerText = e.lockMessage,
            "pass" === e.type) {
        ...
        var p = function() {
            chrome.extension.sendMessage({
                ...
                e && "lock" === e.action && (console.log("[check] locked", e.data),
                s(e.data))
            }
            ))
        };
